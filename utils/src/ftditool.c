...
int main(int argc, char **argv)
{
    ...
    while ((i = getopt(argc, argv, "d::ev:p:l:P:S:wWr")) != -1)
    {
        switch (i)
        {
            case 'd':
            ...
            default:
                ...
                fprintf(stderr, "\t-w write default dual uart mode\n");
                fprintf(stderr, "\t-w write FT245 mode\n");
                fprintf(stderr, "\t-e erase\n");
                fprintf(stderr, "\t-v verbose decoding\n");
                fprintf(stderr, "\t-r restart device\n");
    ...
    {
        fprintf(stderr, "Reset FTDI Chip \n");
        ftdi_usb_reset(ftdi);
        goto done;
    }
